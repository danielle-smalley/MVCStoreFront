...
namespace MVCStoreFront.UI.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,CategoryID,Description,Price,ItemsPerUnit,UnitsOnOrder,UnitsSold,UnitsInStock,StockStatusID,Image")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,CategoryID,Description,Price,ItemsPerUnit,UnitsOnOrder,UnitsSold,UnitsInStock,StockStatusID,Image")] Product product)
        {
            if (ModelState.IsValid)
            {
